...
## ۷. ذرات تاکیدی: دی (day) و دینه (deena)

در زبان پشتو، ذرات خاصی وجود دارند که به انتهای افعال اضافه می‌شوند تا تاکید، امر یا حالت خاصی به جمله بدهند.

### دی (day):
**دی** کاربردهای متعدد دارد:

1. **فعل "بودن"** (سوم شخص مذکر مفرد حال):
   - **هغه خوشحاله دی.** (Hagha khwushāla day) = او خوشحال است.

2. **ضمیر "او"** (مذکر):
   - به معنی "او" یا "همان" استفاده می‌شود.

3. **تاکید یا حالت امری** (وقتی بعد از فعل می‌آید):
   - **راغلی دی!** (Rāghlay day!) = آمده است او! / بیاید! (تاکیدی)
   - **کړه دی!** (Kṛa day!) = بکن! / کرده است! (امری تاکیدی)
   - **ووایه دی!** (Wawāya day!) = بگو! (امری با تاکید)

### دینه (deena):
**دینه** شکل تاکیدی‌تر یا گویشی **دی** است که در بعضی مناطق استفاده می‌شود:
   - **راغلی دینه!** (Rāghlay deena!) = آمده است! (با تاکید بیشتر)
   - احتمالاً از ترکیب **دی** + پسوند تاکیدی **نه** (-na) ساخته شده

> [!NOTE]
> این ذرات در شعر و آهنگ‌های پشتو بسیار رایج هستند و به جملات حالت احساسی یا تاکیدی می‌دهند.

**مثال‌های کاربردی:**
- **سبا راشه دی!** (Sabā rāsha day!) = فردا بیا! (امری تاکیدی)
- **ښه کار وکړه دی.** (Ṣ̌a kār wakṛa day) = کار خوبی کردی! (تحسین با تاکید)
