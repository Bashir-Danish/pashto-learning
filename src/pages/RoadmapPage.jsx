...
const roadmapData = [
  ...
  {
    phase: 5,
    title: 'مرحله ۵: فعل‌های زمان حال',
    titlePashto: 'پنځم پړاو: اوسمهال فعلونه',
    duration: '۲-۳ هفته',
    icon: Play,
    color: 'amber',
  ...
  {
    phase: 6,
    title: 'مرحله ۶: واژگان پایه',
    titlePashto: 'شپږم پړاو: بنسټیز لغات',
    duration: '۲ هفته',
    icon: Library,
    color: 'teal',
  ...
  {
    phase: 8,
    title: 'مرحله ۸: فعل‌های جامع',
    titlePashto: 'اتم پړاو: د فعلونو مجموعه',
    duration: '۱ هفته',
    icon: Play,
    color: 'amber',
  ...
  {
    phase: 9,
    title: 'مرحله ۹: آینده و امری',
    titlePashto: 'نهم پړاو: راتلونکي او امري',
    duration: '۱ هفته',
    icon: ArrowRight,
    color: 'cyan',
